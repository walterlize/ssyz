<div style="margin-left:20px; margin-right:20px">
    ...
    <table class="tablist2" cellpadding="0" cellspacing="1" style="width:100%;border-collapse:collapse;" border="1">
        ...
        <?php if (is_array($expert)) foreach ($expert as $key=>$r): ?>
                <tr class="RowStyle" align="center">
                    ...
                    <td class="td1">
                        <?= $r['subjectName'] ?></td>
                    <td class="td3">
                        <a id="" href="<?= base_url() ?>index.php/admin/expert/expertDetail/<?= $r['expertId'] ?>">详细</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <tr>
            <td colspan="6" align="center" class="td3">
                <input type="button" name="btnDelete" value="新 增" onclick="window.location.href = '<?= base_url() ?>index.php/admin/expert/expertNew';" id="btnDelete" class="input" />
