<div style="margin-left:20px; margin-right:20px;">
    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
      ...
      <!--  <tr>
        ...
        <tr>
            <td colspan="2" class="td3" align="center"><input type="button" name="btnEdit" value="编 辑" onclick="window.location.href='<?= base_url() ?>index.php/admin/subject/subjectEdit/<?= $subjectId ?>';" id="btnEdit" class="input" />
                <input type="button" name="btnSave" value="删 除" onclick="deleteInfo('<?= base_url() ?>index.php/admin/subject/subjectDelete/<?= $subjectId ?>')" id="btnDelete" class="input" />
                <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/admin/subject/subjectManage';" id="btnReturn" class="input" />      </td>
        </tr>
    </table>
</div>