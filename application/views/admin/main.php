    ...
    <div id="container">
        <div class="border">
            ...
            <div class="text_admin_1">
                <span class="c_left"><a href="<?= base_url(); ?>index.php/admin/trend/trendList/1">发布公告</a></span>
                <span class="c_center"><a href="<?= base_url(); ?>index.php/admin/workReport/reportList/WeekReport/1/all">工作月报</a></span>
            ...
            <div class="text_admin_2">
                ...
                <span class="c_right"><a href="<?= base_url() ?>index.php/user/password">增加新用户</a></span>
            </div>
