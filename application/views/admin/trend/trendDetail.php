...
<div class="title_lee"><?=$title?>信息</div>
  <table cellpadding="0" cellspacing="1" class="tablist2">
    ...
    <tr>
      <td colspan="2" class="td3" align="center"><input type="button" name="btnEdit" value="编 辑" onclick="window.location.href='<?=base_url()?>index.php/admin/trend/trendEdit/<?=$trend->trendId?>';" id="btnEdit" class="input" />
      <input type="button" name="btnSave" value="删 除" onclick="deleteInfo('<?=base_url()?>index.php/admin/trend/trendDelete/<?=$trend->trendId?>/<?=$trend->trendType?>')" id="btnDelete" class="input" />
