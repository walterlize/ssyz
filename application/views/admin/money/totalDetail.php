<div style="margin-left:20px; margin-right:20px">
    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
        <tr>
            <td colspan="3" class="td2">课题：课题<?= $money->subjectNum ?>&nbsp;&nbsp;&nbsp;&nbsp;<?= $money->subjectName ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;课题起止时间：&nbsp;自：<?= $money->startDate ?>&nbsp：至：<?= $money->endDate ?></td>
        </tr>
        <tr>
            <td class="td1">类别</td>
        ...
        <tr>
            <td colspan="3" class="td3" align="center"><input type="button" name="btnEdit" value="编 辑" onclick="window.location.href = '<?= base_url() ?>index.php/admin/money/totalMoneyEdit/<?= $money->totalMoneyId ?>';" id="btnEdit" class="input" />
                <input type="button" name="btnDelete" value="删 除" onclick="deleteInfo('<?= base_url() ?>index.php/admin/money/totalMoneyDelete/<?= $money->totalMoneyId ?>')" id="btnDelete" class="input" />
                <input type="button" name="btnReturn" value="返 回" onclick="window.location.href = '<?= base_url() ?>index.php/admin/money/totalList';" id="btnReturn" class="input" />      </td>
        </tr>
    </table>
