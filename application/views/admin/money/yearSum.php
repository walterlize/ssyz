<div id="date_result">
    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
        ...
        <tr>
            ...
            <td class="td3" align="center"><?= $year ?>年经费预算总额</td>
            <td class="td1" align="center"><?= $year ?>年经费已花费的经费</td>
            <td class="td3" align="center"><?= $year ?>剩余的经费</td>
        ...
        <tr>
            <?php if (is_array($moneySum)) foreach ($moneySum as $r): ?>
                    ...
                    <td class="td3">
                        <?= $r['management'] ?></td>
                    <td class="td1">
                        <a id="" href="<?= base_url() ?>index.php/admin/money/yearSumDetail/<?= $r['subjectId'] ?>">详细</a></td>
