            ...
            <?php if (is_array($money)) foreach ($money as $key => $r): ?>
                    <tr class="RowStyle" align="center">
                        ...
                        <td class="td3">
                            <?= $r['money'] ?></td>
                        <td class="td1">
                            <a id="" href="<?= base_url() ?>index.php/ordinary/money/expenseDetail/<?= $r['b_id'] ?>/<?= $r['m_type'] ?>">详情</a>
                        </td>
                    </tr>
                <?php endforeach; ?>

        </table>
        <div align="right"><font color="#3A6EA5" size="3px">总金额<?=$sum?>元。<br/>共有<?= $num ?>条记录。</font></div>
    </div>
</div>