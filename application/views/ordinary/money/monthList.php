        ...
        <?php if (is_array($money)) foreach ($money as $r): ?>
                <tr class="RowStyle" align="center">
                    ...
                    <td>
                        <?= $r['stateInfo'] ?></td>
                    <td>
                        <a id="" href="<?= base_url() ?>index.php/ordinary/money/monthMoneyDetail/<?= $r['monthMoneyId'] ?>">详细</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <tr>
            <td colspan="5" align="center">
                <input type="button" name="btnDelete" value="新 增" onclick="window.location.href='<?= base_url() ?>index.php/ordinary/money/monthMoneyNew';" id="btnDelete" class="input" />
