        ...
        <div class="menu">
            <ul id="nav">
                ...
                <li><a href="#"><span>工作进度</span></a>
                    ...
                    <ul>
                        <li><a href="<?= base_url(); ?>index.php/manager/subject/subjectDetail" target="mainFrame"><span>汇款审核管理</span></a></li>
                        <li><a href="<?= base_url(); ?>index.php/manager/subject/subjectManage" target="mainFrame"><span>报销审核管理</span></a></li>
                    </ul></li>
                ...
                <li><a href="#"><span>子课题经费管理</span></a>
                    <ul>
                        ...
                        <li><a href="<?= base_url(); ?>index.php/manager/money/yearlist/2" target="mainFrame"><span>子课题年度经费填写</span></a></li>
