    ...
    <table cellpadding="0" cellspacing="1" class="tablist2">
        ...
        <tr>
            <td colspan="5" class="td3" align="center">
                <input type="button" name="btnEdit" value="通 过" onclick="window.location.href='<?= base_url() ?>index.php/manager/money/monthMoneyUpdateCheck/<?= $monthMoney->monthMoneyId ?>/3';" id="btnEdit" class="input" style="<?= $show1 ?>" />
                <input type="button" name="btnDelete" value="退 修" onclick="window.location.href='<?= base_url() ?>index.php/manager/money/monthMoneyUpdateCheck/<?= $monthMoney->monthMoneyId ?>/2';" id="btnDelete" class="input" style="<?= $show2 ?>" />
                <input type="button" name="btnDelete" value="同意修改" onclick="window.location.href='<?= base_url() ?>index.php/manager/money/monthMoneyUpdateCheck/<?= $monthMoney->monthMoneyId ?>/1';" id="btnDelete" class="input" style="<?= $show3 ?>" />
                <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?= base_url() ?>index.php/manager/money/monthCheck/2';" id="btnReturn" class="input" />
            </td>
        </tr>
    </table>
    <br />
