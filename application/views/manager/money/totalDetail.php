<div style="margin-left:20px; margin-right:20px">
    <br />
    <div class="title_lee">子课题经费预算表</div>
    <table cellpadding="0" cellspacing="1" class="tablist2">
        ...
        <tr>
            <td colspan="3" class="td3" align="center"><input type="button" name="btnEdit" value="编 辑" onclick="window.location.href = '<?= base_url() ?>index.php/manager/money/totalMoneyEdit/<?= $money->subjectId ?>';" id="btnEdit" class="input" />
                <input type="button" name="btnDelete" value="删 除" onclick="deleteInfo('<?= base_url() ?>index.php/manager/money/totalMoneyDelete/<?= $money->totalMoneyId ?>')" id="btnDelete" class="input" />
                <input type="button" name="btnReturn" value="返 回" onclick="window.location.href = '<?= base_url() ?>index.php/manager/money/totalList';" id="btnReturn" class="input" />      </td>
        </tr>
    </table>
</div>