    ...
    <form name="form1" method="post" action="<?= base_url() ?>index.php/manager/money/totalMoneySave" id="form1">
        ...
        <table cellpadding="0" cellspacing="1" class="tablist2">
            ...
            <tr>
                ...
                <td class="td1" style="color: green">待分配经费(万元)</td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money->direct_cost_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->equipment_1?></td>
                <td class="td3" style="color: green"><?= $money->equipment_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->material_1?></td>
                <td class="td3" style="color: green"><?= $money->material_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->experiment_1?></td>
                <td class="td3" style="color: green"><?= $money->experiment_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->fuel_1?></td>
                <td class="td3" style="color: green"><?= $money->fuel_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->travel_1?></td>
                <td class="td3" style="color: green"><?= $money->travel_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->conference_1?></td>
                <td class="td3" style="color: green"><?= $money->conference_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->international_1?></td>
                <td class="td3" style="color: green"><?= $money->international_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->information_1?></td>
                <td class="td3" style="color: green"><?= $money->information_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->service_1?></td>
                <td class="td3" style="color: green"><?= $money->service_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->consultative_1?></td>
                <td class="td3" style="color: green"><?= $money->consultative_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->other_1?></td>
                <td class="td3" style="color: green"><?= $money->other_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->indirect_cost_1?></td>
                <td class="td3" style="color: green"><?= $money->indirect_cost_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->ji_xiao_1?></td>
                <td class="td3" style="color: green"><?= $money->ji_xiao_2?></td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money->total_1?></td>
                <td class="td3" style="color: green"><?= $money->total_2?></td>
                <td class="td3"></td>
            </tr>
            <tr>
                <td colspan="5" class="td3" align="center"><input type="submit" name="btnSave" value="保 存" onclick="check('form1');" id="btnSave" class="input" />
                    <input type="button" name="btnReturn" value="取 消" onclick="window.location.href = 'javascript:history.go(-1)';" id="btnReturn" class="input" />      </td>
            </tr>
        </table>
    </form>
</div>