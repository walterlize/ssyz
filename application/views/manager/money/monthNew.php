<div style="margin-left:20px; margin-right:20px" id="content">
    <br />
    <h3>月度经费填写</h3>
    <form name="form1" method="post" action="<?= base_url() ?>index.php/manager/money/monthMoneySave" id="form1">
        ...
        <input type="hidden" name="inherit" id="inherit" value="<?= $monthMoney->subjectId ?>" />
        <input type="hidden" name="subjectUnit" id="subjectUnit" value="<?= $subjectUnit ?>" />
        <input type="hidden" name="type" id="type" value="1" />
        <input type="hidden" name="total" id="total" value="<?= $monthMoney->total ?>" />
        <input type="hidden" name="totalyear" id="totalyear" value="<?= $yearMoney->total ?>" />
        <input type="hidden" name="state" id="state" value="1" />
        <table cellpadding="0" cellspacing="1" class="tablist2">
            <tr>
                <td class="td2" colspan="5">
                    请选择年份：
                    <select id="year" name="year" onchange="changeYear('year', 'month', 'content', '<?= base_url() ?>index.php/manager/money/monthMoneyChange')">
            ...
            <tr>
                <td colspan="5" class="td3" align="center"><input type="submit" name="btnSave" value="保 存" onclick="check('form1');" id="btnSave" class="input" />
                    <input type="button" name="btnReturn" value="取 消" onclick="window.location.href='<?= base_url() ?>index.php/manager/money/monthList/1';" id="btnReturn" class="input" />      </td>
            </tr>
        </table>
        <!--   <div>
          
            <table cellpadding="0" cellspacing="1" class="tablist2">
                <form method="post" action="<?= base_url() ?>index.php/manager/upload/uploadfile/<?= $monthMoney->subjectId ?>" enctype="multipart/form-data" />
                ...
                <tr>
                    <td colspan="2" class="td2"><?php if (isset($error)) print_r($error); ?></td>
                </tr>
                </form>
            </table>
