...
<div style="margin-left:20px; margin-right:20px">
    ...
    <form name="form1" method="post" action="<?= base_url() ?>index.php/manager/money/totalMoneySave" id="form1">
        ...
        <input type="hidden" name="subjectId" id="subjectId" value="<?= $money->subjectId ?>" />
        <input type="hidden" name="subjecName" id="subjectName" value="<?= $money->subjectName ?>" />
        <table cellpadding="0" cellspacing="1" class="tablist2">
            <tr>
                <td class="td2" colspan="5">
                    <font size="3px"> 课题：<?= $money->subjectName ?></font>
                </td>
            </tr>
            <tr>
                <td class="td1">类别</td>
            ...
            <tr>
                ...
                <td class="td3"><?= $money1->direct_cost_1?></td>
                <td class="td3" style="color: green"><?= $money1->direct_cost_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->equipment_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->material_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->experiment_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->fuel_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->travel_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->conference_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->international_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->information_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->service_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->consultative_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->other_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->indirect_cost_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->ji_xiao_2?></td>
            ...
            <tr>
                ...
                <td class="td3" style="color: green"><?= $money1->total_2?></td>
                <td class="td3"></td>
            </tr>
            <tr>
