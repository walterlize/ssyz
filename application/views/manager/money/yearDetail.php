...
<h3>年度经费预算表</h3>
  <table cellpadding="0" cellspacing="1" class="tablist2">
    ...
    <tr>
      <td colspan="3" class="td3" align="center"><input type="button" name="btnEdit" value="编 辑" onclick="window.location.href='<?=base_url()?>index.php/manager/money/yearMoneyEdit/<?=$money->yearMoneyId?>';" id="btnEdit" class="input" />
      	  <input type="button" name="btnDelete" value="删 除" onclick="deleteInfo('<?=base_url()?>index.php/manager/money/yearMoneyDelete/<?=$money->yearMoneyId?>')" id="btnDelete" class="input" />
          <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?=base_url()?>index.php/manager/money/yearList/2';" id="btnReturn" class="input" />      </td>
    </tr>
  </table>
 </div>