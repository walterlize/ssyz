  ...
  <table cellpadding="0" cellspacing="1" class="tablist2">
    ...
    <tr>
      <td colspan="5" class="td3" align="center">
      	<input type="button" name="btnEdit" value="编 辑" onclick="window.location.href='<?=base_url()?>index.php/manager/money/monthMoneyEdit/<?=$monthMoney->monthMoneyId?>';" id="btnEdit" class="input" style="<?=$show1?>" />
      	<input type="button" name="btnDelete" value="删 除" onclick="deleteInfo('<?=base_url()?>index.php/manager/money/monthMoneyDelete/<?=$monthMoney->monthMoneyId?>')" id="btnDelete" class="input" style="<?=$show1?>" />
        <input type="button" name="btnUpdate" value="请求修改" onclick="window.location.href='<?=base_url()?>index.php/manager/money/monthMoneyUpdate/<?=$monthMoney->monthMoneyId?>/0';" id="btnUpdate" class="input" style="<?=$show2?>" />
        <input type="button" name="btnReturn" value="返 回" onclick="window.location.href='<?=base_url()?>index.php/manager/money/monthList/1';" id="btnReturn" class="input" />      </td>
    </tr>
  </table>
