...
<div style="margin-left:20px; margin-right:20px" id="content">
    <form name="form1" method="post" action="<?= base_url() ?>index.php/manager/check/checkLaowu/<?= $laowu->laowu_id ?>/1" id="form1">
        <table class="tablist2" cellpadding="0" cellspacing="1">
            ...
            <tr>  <td class="td1" style="width: 111px"><font color="red">批复情况：</font></td>
                <td class="td2" colspan="2">
                    ...
                    <textarea name="remark" id="remark" style="visibility:hidden; width:100%; 
                              height:200px;"><?= $laowu->remark ?></textarea>
            ...
            <tr>
                <td colspan="3" class="td3" align="center">
                    ...
                    <input type="button" name="btnNext" value="返 回" onclick="window.location.href = '<?= base_url(); ?>index.php/manager/check/laowuManage';" id="btnSave"class="input"/>
                </td></tr>
</div>  </table>
</form>
</div>