        ...
        <?php if (is_array($subject)) foreach ($subject as $key=>$r): ?>
                <tr class="RowStyle" align="center">
                    ...
                    <td class="td1">
                        <?= $r['expert'] ?></td>
                    <td class="td3">
                        <a id="" href="<?= base_url() ?>index.php/manager/subject/ziSubjectDetail/<?= $r['subjectId'] ?>">详细</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <tr>
            <td colspan="6" align="center"class="td3">
                <input type="button" name="btnDelete" value="新 增" onclick="window.location.href='<?= base_url() ?>index.php/manager/subject/subjectNew';" id="btnDelete" class="input" />
