...
<div class=pnav-cnt>
    <div class=pnav-box id=letter-a>
        <div class=box-title>
            ...
            <SPAN class=pnav-letter>课题简介</SPAN>
        </div>
        <ul class="box-list hidden">
            <li><B><A href="<?=base_url()?>index.php/outside/subject/project">课题概况</A></B></li>
            <li><B><A href="<?=base_url()?>index.php/outside/subject/expert">课题执行专家组</A></B></li>
        </ul>
    </div>
    <div class=pnav-box id=letter-a>
        <div class=box-title>
    ...
    <div class=pnav-box id=letter-a>
        <div class=box-title>
            <A class="btn-fold " href=""></A>
            <A class="btn-unfold hidden" href=""></A>
            <SPAN class=pnav-letter>课题动态</SPAN>
        </div>
        <ul class="box-list hidden">
            <li><B><A href="<?=base_url()?>index.php/outside/trend/index/2">课题动态</A></B></li>
        </ul>
    </div>
    <div class=pnav-box id=letter-a>
        <div class=box-title>
